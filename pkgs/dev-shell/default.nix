{ mkShell, python3, claude-code, gemini-cli, codex }:
...
in mkShell rec {
  ...
  packages = [ my-nix-pkgs-dev claude-code gemini-cli codex ];
  ...
  shellHook = ''
    ...
    echo "Available packages: tushare, pyexecjs, claude-code, gemini-cli, codex"
