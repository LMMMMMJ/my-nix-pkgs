{ mkShell, python3, claude-code, claude-code-router, gemini-cli, codex }:
...
in mkShell rec {
  ...
  packages = [ my-nix-pkgs-dev claude-code claude-code-router gemini-cli codex ];
  ...
  shellHook = ''
    ...
    echo "Available packages: tushare, pyexecjs, claude-code, claude-code-router, gemini-cli, codex"
